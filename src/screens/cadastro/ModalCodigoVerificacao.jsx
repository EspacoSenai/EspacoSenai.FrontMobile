                ...
                <View style={styles.inputsContainer}>
                  {values.map((v, i) => (
                    <TextInput
                      ...
                      maxLength={length} // Permite mais caracteres para capturar o "Paste", a lógica corta depois
                      keyboardType="default" // Pode mudar para 'number-pad' se o código for só números
...
const styles = StyleSheet.create({
  ...
  inputsContainer: {
    flexDirection: "row",
    justifyContent: "center",
    gap: 12, // Nota: 'gap' funciona nas versões mais recentes do RN. Se for antigo, use margin nos inputs
    marginTop: 20,
  },
  input: {
    width: 48, // w-12
